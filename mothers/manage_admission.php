    ...
    <form action="" id="patient-history-form">
            ...
            <div class="form-group col-lg-6 col-md-8 cols-sm-12">
                ...
                <select name="room_id" id="room_id" class="form-control form-control-border select2">
                    ...
                    while ($row = $qry->fetch_assoc()):
                        ?>
                        <option <?= $row['delete_flag'] == 1 ? "disabled" : "" ?> <?= isset($room_id) && $room_id == $row['id'] ? "selected" : '' ?>
        ...
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <input type="datetime-local" name="date_admitted" id="date_admitted"
                       class="form-control form-control-border"
                       value="<?= isset($date_admitted) ? date("Y-m-d\TH:i", strtotime($date_admitted)) : "" ?>"
                       required>
            </div>
            <div class="form-group col-md-6">
                <label for="date_discharged" class="control-label">Date Discharged</label>
                <input type="datetime-local" name="date_discharged" id="date_discharged"
                       class="form-control form-control-border"
