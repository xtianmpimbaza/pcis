    ...
    <form action="" id="patient-form">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="lastname" id="lastname" class="form-control form-control-border"
                       placeholder="Last Name" value="<?php echo isset($lastname) ? $lastname : '' ?>" required>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-6">
                <label for="email" class="control-label">Email</label>
                <input type="email" name="email" id="email" class="form-control form-control-border" placeholder="Email"
        ...
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <input name="address" id="address" class="form-control form-control-border"
                       placeholder="Block 6, Mubs street" required
                       value="<?php echo isset($address) ? $address : '' ?>"/>
            </div>
            <div class="form-group col-md-6">
                <label for="dob" class="control-label">Date of Birth</label>
                <input type="date" name="dob" id="dob" class="form-control form-control-border" placeholder="Contact #"
