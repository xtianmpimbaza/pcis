                ...
                <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                    ...
                    <nav class="mt-4">
                        <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child"
                            ...
                            <li class="nav-item">
                                <a href="<?php echo base_url ?>?page=manage_registration"
                                   class="nav-link nav-manage_registration">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo base_url ?>?page=registration_list"
                                   class="nav-link nav-registration_list">
